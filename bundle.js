...
var ItcSlider = /*#__PURE__*/function () {
  ...
  function ItcSlider(_el) {
    ...
    _classPrivateFieldSet(_state, this, {
      ...
      exTranslateMax: 0,
      direction: 'next',
      // РЅР°РїСЂР°РІР»РµРЅРёРµ СЃРјРµРЅС‹ СЃР»Р°Р№РґРѕРІ
      intervalId: null,
      // id С‚Р°Р№РјРµСЂР°
      isSwiping: false,
      swipeX: 0
  ...
  return _createClass(ItcSlider, [{
    ...
    value: function dispose() {
      ...
      var index = _assertClassBrand(ItcSlider, this.constructor, _instances)._.findIndex(function (el) {
        return el.target === _classPrivateFieldGet(_state, _this).el;
      });
...
function _onResize() {
  window.requestAnimationFrame(_assertClassBrand(_ItcSlider_brand, this, _reset).bind(this));
}
...
function _onSwipeEnd(e) {
  ...
  var diffPos = _classPrivateFieldGet(_state, this).swipeX - event.clientX;
  if (diffPos > 50) {
    _classPrivateFieldGet(_state, this).direction = 'next';
    _assertClassBrand(_ItcSlider_brand, this, _move).call(this);
  } else if (diffPos < -50) {
...
function _onTransitionStart() {
  ...
  window.requestAnimationFrame(_assertClassBrand(_ItcSlider_brand, this, _balanceItems).bind(this));
}
...
function _attachEvents() {
  ...
  _classPrivateFieldGet(_state, this).events = {
    ...
    'resize': [window, _assertClassBrand(_ItcSlider_brand, this, _onResize).bind(this), _classPrivateFieldGet(_config, this).refresh],
    'itc-slider__transition-start': [_classPrivateFieldGet(_state, this).elItems, _assertClassBrand(_ItcSlider_brand, this, _onTransitionStart).bind(this), _classPrivateFieldGet(_config, this).loop],
    ...
    'touchstart': [_classPrivateFieldGet(_state, this).el, _assertClassBrand(_ItcSlider_brand, this, _onSwipeStart).bind(this), _classPrivateFieldGet(_config, this).swipe],
    'mousedown': [_classPrivateFieldGet(_state, this).el, _assertClassBrand(_ItcSlider_brand, this, _onSwipeStart).bind(this), _classPrivateFieldGet(_config, this).swipe],
    'touchend': [document, _assertClassBrand(_ItcSlider_brand, this, _onSwipeEnd).bind(this), _classPrivateFieldGet(_config, this).swipe],
    'mouseup': [document, _assertClassBrand(_ItcSlider_brand, this, _onSwipeEnd).bind(this), _classPrivateFieldGet(_config, this).swipe],
    ...
    'keydown': [document, _assertClassBrand(_ItcSlider_brand, this, _onKeyDown).bind(this), true]
  };
  Object.keys(_classPrivateFieldGet(_state, this).events).forEach(function (type) {
    if (_classPrivateFieldGet(_state, _this3).events[type][2]) {
      var el = _classPrivateFieldGet(_state, _this3).events[type][0];
      var fn = _classPrivateFieldGet(_state, _this3).events[type][1];
...
function _detachEvents() {
  var _this4 = this;
  Object.keys(_classPrivateFieldGet(_state, this).events).forEach(function (type) {
    if (_classPrivateFieldGet(_state, _this4).events[type][2]) {
      var el = _classPrivateFieldGet(_state, _this4).events[type][0];
      var fn = _classPrivateFieldGet(_state, _this4).events[type][1];
...
function _autoplay(action) {
  ...
  if (_classPrivateFieldGet(_state, this).intervalId === null) {
    _classPrivateFieldGet(_state, this).intervalId = setInterval(function () {
      _classPrivateFieldGet(_state, _this5).direction = 'next';
      _assertClassBrand(_ItcSlider_brand, _this5, _move).call(_this5);
  ...
  if (_classPrivateFieldGet(_state, this).direction === 'next') {
    ...
    if (exItemRectRight < wrapperRect.left - targetWidth) {
      var elFound = _classPrivateFieldGet(_state, this).els.find(function (item) {
        return item.el === _classPrivateFieldGet(_state, _this6).exItemMin;
      });
    ...
    if (exItemRectLeft > wrapperRect.right + targetWidth) {
      var _elFound = _classPrivateFieldGet(_state, this).els.find(function (item) {
        return item.el === _classPrivateFieldGet(_state, _this6).exItemMax;
      });
...
function _updateClasses() {
  ...
  _classPrivateFieldGet(_state, this).activeItems.forEach(function (item, index) {
    if (item) {
      _classPrivateFieldGet(_state, _this7).elListItem[index].classList.add(activeClass);
    } else {
      _classPrivateFieldGet(_state, _this7).elListItem[index].classList.remove(activeClass);
    }
    var elListIndicators = _classPrivateFieldGet(_state, _this7).el.querySelectorAll(".".concat(_classPrivateFieldGet(_state, _this7).prefix).concat(_assertClassBrand(_ItcSlider, _this7.constructor, _EL_INDICATOR)._));
    if (elListIndicators.length && item) {
      elListIndicators[index].classList.add("".concat(_classPrivateFieldGet(_state, _this7).prefix).concat(_assertClassBrand(_ItcSlider, _this7.constructor, _EL_INDICATOR_ACTIVE)._));
    } else if (elListIndicators.length && !item) {
      elListIndicators[index].classList.remove("".concat(_classPrivateFieldGet(_state, _this7).prefix).concat(_assertClassBrand(_ItcSlider, _this7.constructor, _EL_INDICATOR_ACTIVE)._));
    }
  });
...
function _move() {
  ...
  _classPrivateFieldGet(_state, this).elItems.dispatchEvent(new CustomEvent('itc-slider__transition-start', {
    bubbles: true
  }));
}
...
function _init() {
  ...
  _classPrivateFieldGet(_state, this).width = _classPrivateFieldGet(_state, this).elListItem[0].getBoundingClientRect().width;
  ...
  _classPrivateFieldGet(_state, this).elListItem.forEach(function (el, index) {
    el.style.transform = '';
    _classPrivateFieldGet(_state, _this8).activeItems.push(index < _classPrivateFieldGet(_state, _this8).countActiveItems ? 1 : 0);
    _classPrivateFieldGet(_state, _this8).els.push({
      el: el,
      index: index,
      order: index,
      translate: 0
...
function _reset() {
  ...
  var widthItem = _classPrivateFieldGet(_state, this).elListItem[0].getBoundingClientRect().width;
  var widthWrapper = _classPrivateFieldGet(_state, this).elWrapper.getBoundingClientRect().width;
  ...
  window.requestAnimationFrame(function () {
    _classPrivateFieldGet(_state, _this9).elItems.classList.remove(transitionNoneClass);
  });
}
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  ...
  function stepSelect() {
    var stepButtons = document.querySelectorAll(".way-section__left-name");
    var dropdownToggle = document.querySelector(".dropdown-toggle");
    var changeBorder = function changeBorder(btn) {
      if (mediaQuery.big.matches) {
        stepButtons.forEach(function (item) {
          return item.classList.remove("active-border");
        });
        btn.classList.add("active-border");
      }
    };
    var makeActiveContent = function makeActiveContent(btn) {
      var prevActiveItem = document.querySelector(".way-section__right.active");
      if (prevActiveItem) {
        prevActiveItem.classList.remove("active");
      }
      var dataTargetItem = btn.getAttribute("data-target");
      var contentItem = document.getElementById(dataTargetItem);
      contentItem.classList.add("active");
    };
    var updateDropdownText = function updateDropdownText(btn) {
  ...
  function makeDropdown() {
    var dropdown = document.querySelector(".way-section__left");
    var dropdownMenu = document.querySelector(".tabs");
    var dropdownItem = document.querySelectorAll(".way-section__left-name");
    var addClassForDropdown = function addClassForDropdown() {
      if (mediaQuery.xs.matches) {
        dropdown.classList.add("dropdown");
        dropdownMenu.classList.add("dropdown-menu");
        dropdownItem.forEach(function (element) {
          return element.classList.add("dropdown-item");
        });
      } else {
        dropdown.classList.remove("dropdown");
        dropdownMenu.classList.remove("dropdown-menu");
        dropdownItem.forEach(function (element) {
          return element.classList.remove("dropdown-item");
        });
      }
    };
  ...
  function dragEllipse() {
    var parallaxScene1 = document.getElementById("parallax-scene-1");
    if (parallaxScene1) {
      new (parallax_js__WEBPACK_IMPORTED_MODULE_1___default())(parallaxScene1, {
        limitX: false,
        limitY: false,
        scalarX: 20,
        scalarY: 60,
    ...
    var parallaxScene2 = document.getElementById("parallax-scene-2");
    if (parallaxScene2) {
      new (parallax_js__WEBPACK_IMPORTED_MODULE_1___default())(parallaxScene2, {
        limitX: 150,
        limitY: false,
        scalarX: 5,
        scalarY: 20,
  ...
  var VisibleToggle = /*#__PURE__*/function () {
    function VisibleToggle(element) {
      _classCallCheck(this, VisibleToggle);
      this.element = element;
    }
    return _createClass(VisibleToggle, [{
      key: "displayFlex",
      value: function displayFlex() {
        this.element.style.display = "flex";
      }
    }, {
      key: "displayNoneTimeOut350",
      value: function displayNoneTimeOut350() {
        var _this = this;
        setTimeout(function () {
      ...
      key: "displayBlockOpacity1",
      value: function displayBlockOpacity1() {
        var _this2 = this;
      ...
      key: "displayNoneOpacity0",
      value: function displayNoneOpacity0() {
        var _this3 = this;
  ...
  var RightSlideToggle = /*#__PURE__*/function () {
    function RightSlideToggle(element) {
      _classCallCheck(this, RightSlideToggle);
      this.element = element;
    }
    return _createClass(RightSlideToggle, [{
      key: "slideIn",
      value: function slideIn() {
        var _this4 = this;
        setTimeout(function () {
          _this4.element.style.transform = "translateX(0%)";
        }, 10);
      }
    }, {
      key: "slideOut",
  ...
  function makeSideBar() {
    ...
    var checkbox = document.querySelector(".header-section__toggle");
    var blackOut = document.querySelector(".blackout");
    var toggleButton = document.querySelector('.header-section__button');
    var toggleButtonClose = document.querySelector('.header-section__button_close');
    var menuItem = document.querySelectorAll('.header-section__link');
    var blackOutToggle = new VisibleToggle(blackOut);
    var menuVisibleToggle = new VisibleToggle(menu);
    var menuSlideToggle = new RightSlideToggle(menu);
    ...
    toggleButtonClose.addEventListener('keydown', function (event) {
      if (event.key === 'Enter') {
        checkbox.checked = !checkbox.checked;
        menuSlide(checkbox.checked);
      } else if (event.key === 'Escape') {
